...
import { ArrowRight, Calendar, ExternalLink, Download, Filter } from 'lucide-react';
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <nav className="flex items-center justify-center gap-2 text-white/60 text-sm mb-6">
              ...
              <span>/</span>
              <span className="text-accent">Press Releases</span>
            </nav>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Press Releases
            </h1>
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Stay updated with our latest news, updates, and achievements.
            </p>
          </motion.div>
        </div>
      </section>
