...
const WhatsAppCRM = () => {
    return (<ServiceDetailPage icon={MessageSquare} color="from-green-500 to-green-600" title="WhatsApp CRM" tagline="Customer Management Right in WhatsApp" description="Turn WhatsApp into your primary CRM. Manage leads, close deals, and support customers directly from your team's WhatsApp inbox with automated tracking." benefits={[
        ...
        ]} technologies={['WhatsApp API', 'Node.js', 'PostgreSQL', 'Twilio', 'AWS', 'Webhooks']} caseStudies={[
            {
