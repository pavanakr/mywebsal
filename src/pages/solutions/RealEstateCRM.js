import { Building2, MessageSquare, Zap, Bot } from 'lucide-react';
import { ServiceDetailPage } from '@/components/services/ServiceDetailPage';
const RealEstateCRM = () => {
    return (<ServiceDetailPage icon={Building2} color="from-sky-500 to-blue-600" title="Real Estate CRM" tagline="Enterprise-Grade Property & Lead Management CRM" description="Streamline your real estate business with our specialized CRM. Designed for brokers, developers, and agents in India to manage properties, leads, and sales pipelines with WhatsApp & AI automation." benefits={[
        ...
        ]} technologies={['React', 'Node.js', 'PostgreSQL', 'WhatsApp API', 'Meta API', 'AWS', 'Redis', 'Python']} caseStudies={[
            {
                title: 'PropView360',
