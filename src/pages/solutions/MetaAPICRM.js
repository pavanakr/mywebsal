...
const MetaAPICRM = () => {
    return (<ServiceDetailPage icon={MessageSquare} color="from-green-600 to-emerald-700" title="Meta API CRM" tagline="Official Meta API & WhatsApp CRM Integration" description="Leverage the power of the official Meta Business API. We build high-volume, reliable WhatsApp CRM solutions that scale with your business communications." benefits={[
        ...
        ]} technologies={['WhatsApp API', 'Meta API', 'Node.js', 'Redis', 'PostgreSQL', 'AWS', 'Webhooks']} caseStudies={[
            {
