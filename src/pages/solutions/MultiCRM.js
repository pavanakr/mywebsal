...
const MultiCRM = () => {
    return (<ServiceDetailPage icon={Layers} color="from-purple-500 to-indigo-600" title="Multi CRM" tagline="Unified CRM for Multi-Business & Multi-Industry Operations" description="Manage multiple business units from one powerful dashboard. Our Multi CRM platform allows centralized control for diversified enterprises while maintaining data isolation." benefits={[
        ...
        ]} technologies={['React', 'Node.js', 'PostgreSQL', 'Multi-Tenancy', 'AWS', 'GraphQL', 'Docker', 'Kubernetes']} caseStudies={[
            {
