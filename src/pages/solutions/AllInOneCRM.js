import { LayoutGrid, MessageSquare, Layers } from 'lucide-react';
import { ServiceDetailPage } from '@/components/services/ServiceDetailPage';
const AllInOneCRM = () => {
    return (<ServiceDetailPage icon={LayoutGrid} color="from-orange-500 to-red-600" title="All-in-One CRM" tagline="The Complete Sales, Marketing & Automation Suite" description="Stop switching between tabs. Our All-in-One CRM combines sales automation, marketing outreach, and WhatsApp customer support in one unified platform." benefits={[
        ...
        ]} technologies={['React', 'Node.js', 'PostgreSQL', 'WhatsApp API', 'Stripe', 'Twilio', 'OpenAI', 'AWS']} caseStudies={[
            {
