                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        required
placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Continue from the existing SEO implementation.\n\nNow implement LOCAL SEO for:\n\nIndia\n\nHyderabad\n\nKPHB\n\nKukatpally\n\nIMPORTANT:\nDo not create thin doorway pages.\n\nDo not copy the same page and simply replace Hyderabad with KPHB or Kukatpally.\n\nEach location page must provide genuinely useful and unique content.\n\nCREATE OR OPTIMIZE:\n\nSoftware Development Company in Hyderabad\n\nURL:\n/software-development-company-hyderabad/\n\nTarget natural topics:\n\nsoftware company in Hyderabad\n\nsoftware development company Hyderabad\n\nsoftware solutions Hyderabad\n\nCRM development Hyderabad\n\nAI development Hyderabad\n\nSaaS development Hyderabad\n\ncustom software development Hyderabad\n\nSoftware Development Company in KPHB\n\nURL:\n/software-development-company-kphb/\n\nTarget:\n\nsoftware company KPHB\n\nsoftware development KPHB\n\nIT company KPHB\n\nCRM development KPHB\n\nAI development KPHB\n\nSaaS development KPHB\n\nSoftware Development Company in Kukatpally\n\nURL:\n/software-development-company-kukatpally/\n\nTarget:\n\nsoftware company Kukatpally\n\nsoftware development Kukatpally\n\nIT company Kukatpally\n\nCRM development Kukatpally\n\nAI development Kukatpally\n\nSaaS development Kukatpally\n\nEach page must contain unique:\n\nintroduction\n\nlocal business context\n\nservices\n\nCRM solutions\n\nAI solutions\n\nsoftware development capabilities\n\nindustries\n\nprocess\n\nbenefits\n\nFAQs\n\ncontact CTA\n\ninternal links\n\nUse the company's REAL business address and contact details.\n\nDO NOT invent:\n\noffices\n\nbranches\n\nreviews\n\nclients\n\nawards\n\nlocations\n\nImplement appropriate LocalBusiness/Organization structured data only when accurate.\n\nAlso optimize the Contact page for local SEO.\n\nMake sure the company name, address, phone and website are consistent.\n\nCreate strong internal linking:\n\nHyderabad page\n→ CRM\n→ AI\n→ Software Development\n→ Real Estate CRM\n\nKPHB page\n→ Software Development\n→ CRM\n→ AI\n\nKukatpally page\n→ Software Development\n→ CRM\n→ AI\n\nTest every page after implementation."
                        value={formData.name}
