                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Input
                        type="email"
                        required
                        placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Continue from the SEO foundation already implemented.\n\nIMPORTANT:\n\nDo NOT repeat Phase 1.\n\nDo NOT redesign the website.\n\nDo NOT break existing functionality.\n\nOptimize existing pages before creating duplicates.\n\nTASK:\n\nImplement strong on-page SEO for the existing website.\n\nFor every important public page:\n\nCreate a unique SEO title.\n\nCreate a unique meta description.\n\nEnsure exactly one meaningful H1.\n\nImprove H2/H3 hierarchy.\n\nImprove page copy naturally.\n\nAdd descriptive internal links.\n\nAdd relevant CTA sections.\n\nAdd relevant image alt text.\n\nAdd canonical URLs.\n\nAdd Open Graph metadata.\n\nAdd Twitter/X metadata.\n\nAdd breadcrumbs where appropriate.\n\nPrimary keyword themes:\n\nSoftware:\n\nsoftware company in India\n\nsoftware development company India\n\nsoftware company Hyderabad\n\nsoftware development company Hyderabad\n\ncustom software development\n\nSaaS development\n\nweb application development\n\nmobile app development\n\nCRM:\n\nCRM software\n\nCRM development\n\nbusiness CRM\n\nsales CRM\n\nWhatsApp CRM\n\nCRM automation\n\nAI:\n\nAI software development\n\nAI chatbot development\n\nAI automation\n\nconversational AI\n\nAI business automation\n\nDo NOT keyword stuff.\n\nDo NOT use the same keyword repeatedly just to manipulate rankings.\n\nOptimize existing core service pages for:\n\nCustom Software Development\n\nWeb Development\n\nMobile App Development\n\nSaaS Development\n\nCRM Development\n\nAI Development\n\nAI Chatbot Development\n\nAPI Development\n\nUI/UX Development\n\nBusiness Automation\n\nIf a page already exists, optimize it.\n\nOnly create a new page if the required service genuinely does not exist.\n\nAt the end:\n\ntest every modified route\n\nverify metadata\n\nverify headings\n\nverify links\n\nverify responsive layout\n\nGive me a concise Phase 2 completion report."
