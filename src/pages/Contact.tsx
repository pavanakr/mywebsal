...
const Contact = () => {
  ...
  const commandPlaceholder = "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n\nas per attachment refference do sliders \n\nModify ONLY the existing homepage hero/header slider in my current project.\n\nDo not redesign the navbar.\nDo not change any other homepage sections.\nDo not remove existing functionality.\n\nThe current slider looks too plain and uses a dark laptop background. Replace it with a premium, colorful AI/SaaS-style hero slider that matches the existing SOFTURECS AI LABS branding.\n\nCreate 5 slides:\n\nSLIDE 1 — AI CHATBOTS\nTitle:\nAI Chatbots That Work 24/7\n\nSubtitle:\nAutomate conversations, qualify leads, support customers and turn interactions into business opportunities.\n\nCTA:\nExplore AI Solutions\n\nVisual:\nModern AI chatbot interface, friendly AI assistant, chat conversations, customer support and analytics.\n\nSLIDE 2 — AI AUTOMATION\nTitle:\nAutomate Your Business With AI\n\nSubtitle:\nConnect leads, conversations, follow-ups and business workflows with intelligent AI automation.\n\nCTA:\nExplore AI Automation\n\nVisual:\nAI automation workflow with connected nodes such as Lead Capture → AI Processing → Smart Response → Lead Qualification → CRM.\n\nSLIDE 3 — REAL ESTATE CRM\nTitle:\nReal Estate CRM Built for Growth\n\nSubtitle:\nManage properties, leads, agents, follow-ups and sales from one intelligent platform.\n\nCTA:\nExplore Real Estate CRM\n\nVisual:\nPremium real-estate CRM dashboard with properties, leads, sales pipeline, analytics and agent management.\n\nSLIDE 4 — WHATSAPP + META API CRM\nTitle:\nTurn WhatsApp Conversations Into Sales\n\nSubtitle:\nConnect WhatsApp and Meta APIs with your CRM to manage conversations, leads and automation.\n\nCTA:\nExplore WhatsApp CRM\n\nVisual:\nWhatsApp conversations connected to CRM, automated replies, lead management and analytics.\n\nSLIDE 5 — ALL-IN-ONE CRM\nTitle:\nOne CRM. Your Entire Business.\n\nSubtitle:\nBring sales, marketing, customer support, automation and business operations together in one powerful platform.\n\nCTA:\nExplore CRM Solutions\n\nVisual:\nModern SaaS CRM dashboard with sales pipeline, analytics, automation and customer management.";
