                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        required
                        placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            This is the FINAL SEO AUDIT.\n\nDo not add unnecessary new features.\n\nDo not redesign the website.\n\nInspect the complete website after all previous SEO phases.\n\nPerform a production-level SEO audit.\n\nCHECK:\n\nTECHNICAL SEO\n\nsitemap.xml\n\nrobots.txt\n\ncanonical URLs\n\nHTTPS\n\nredirects\n\n404\n\ncrawlability\n\nindexability\n\nduplicate URLs\n\nnoindex\n\nbroken links\n\nON-PAGE SEO\n\nunique title on every important page\n\nunique meta description\n\none H1\n\ncorrect H2/H3 structure\n\nimage alt text\n\ninternal links\n\nbreadcrumbs\n\nOpen Graph\n\nTwitter metadata\n\nLOCAL SEO\n\nIndia\n\nHyderabad\n\nKPHB\n\nKukatpally\n\nNAP consistency\n\nlocal schema\n\ncontact information\n\nlocal landing pages\n\nPRODUCT SEO\n\nReal Estate CRM\n\nMulti CRM\n\nAll-in-One CRM\n\nMeta API CRM\n\nWhatsApp CRM\n\nAI SEO\n\nAI Chatbot Development\n\nAI Automation\n\nAI Development\n\nSTRUCTURED DATA\n\nOrganization\n\nLocalBusiness where appropriate\n\nWebSite\n\nWebPage\n\nService\n\nBreadcrumbList\n\nArticle\n\nINTERNAL LINKING\n\nfooter\n\nheader\n\ncontextual links\n\nrelated pages\n\norphan pages\n\nPERFORMANCE\n\nmobile\n\ndesktop\n\nimages\n\nJavaScript\n\nCSS\n\nfonts\n\nCore Web Vitals readiness\n\nSECURITY\n\nno API keys exposed\n\nno secrets exposed\n\nno admin/private content indexed\n\nFINAL REQUIREMENT:\n\nFix all issues that can be safely fixed automatically.\n\nDo not claim external SEO work has been completed if it requires access to Google Search Console, Google Business Profile, external directories, backlink websites or third-party platforms.\n\nAt the end provide:\n\nSEO issues found\n\nSEO issues fixed\n\nPages created\n\nPages optimized\n\nTechnical SEO completed\n\nLocal SEO completed\n\nProduct SEO completed\n\nSchema implemented\n\nInternal linking completed\n\nFooter SEO completed\n\nRemaining external SEO tasks\n\nAny issues requiring manual action\n\nThe website must be production-ready from an on-page, technical, local and internal SEO perspective."
                        value={formData.name}
