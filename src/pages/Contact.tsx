                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        required
                        placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Continue from the SEO work already completed.\n\nNow prepare the website for off-page SEO.\n\nDo NOT redesign anything.\n\nDo NOT change existing functionality.\n\nTASK:\n\nAudit the current company/brand information across the website.\n\nMake sure the following company name is consistent everywhere:\n\nSOFTURECS AI LABS PRIVATE LIMITED\n\nCheck the About, Contact, Footer and Organization schema.\n\nMake sure the company name, website, phone and real business address are consistent.\n\nFix inconsistencies only where necessary.\n\nDo not invent or add any business information.\n\nDo not create backlinks or external listings.\n\nAfter completing this task, test the affected pages and report what was changed."
                        value={formData.name}
