                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        required
                        placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Continue from the completed SEO implementation.\n\nNow create a useful Resources/Insights architecture for SEO authority.\n\nTASK:\n\nCheck whether /insights/, /blog/, or /resources/ already exists.\n\nReuse the existing structure if available.\n\nCreate only what is missing.\n\nOrganize content into:\n\nCRM\n\nReal Estate CRM\n\nWhatsApp CRM\n\nMeta API\n\nAI\n\nSaaS\n\nSoftware Development\n\nBusiness Automation\n\nAdd proper SEO metadata.\n\nAdd breadcrumbs.\n\nAdd related-content links.\n\nLink relevant articles to commercial pages such as:\n\nReal Estate CRM\n\nMeta API CRM\n\nWhatsApp CRM\n\nAI Chatbot Development\n\nSoftware Development\n\nDo not generate articles yet.\n\nDo not create keyword-stuffed pages.\n\nDo not redesign the website.\n\nTest the architecture after implementation."
                        value={formData.name}
