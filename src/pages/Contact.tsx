                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Input
                        type="tel"
placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Continue from all previous SEO phases.\n\nNow focus ONLY on internal linking and the global footer.\n\nIMPORTANT:\nCreate ONE reusable global footer component.\n\nThe footer must automatically appear on every relevant public page.\n\nDo not duplicate footer code manually across pages.\n\nCreate these logical footer sections:\n\nSERVICES\n\nCustom Software Development\n\nWeb Development\n\nMobile App Development\n\nSaaS Development\n\nCRM Development\n\nAI Development\n\nAI Chatbot Development\n\nAPI Development\n\nCRM SOLUTIONS\n\nReal Estate CRM\n\nMulti CRM\n\nAll-in-One CRM\n\nMeta API CRM\n\nWhatsApp CRM\n\nAI SOLUTIONS\n\nAI Chatbot Development\n\nAI Automation\n\nConversational AI\n\nLOCATIONS\n\nSoftware Development Company in India\n\nSoftware Development Company in Hyderabad\n\nSoftware Development Company in KPHB\n\nSoftware Development Company in Kukatpally\n\nCOMPANY\n\nAbout\n\nIndustries\n\nInsights\n\nContact\n\nCareers\n\nLEGAL\n\nPrivacy Policy\n\nTerms & Conditions\n\nCookie Policy\n\nIMPORTANT:\n\nDo NOT make the footer look like keyword spam.\n\nDo NOT add hundreds of links.\n\nUse natural anchor text.\n\nDo NOT hide links.\n\nDo NOT repeat the same exact keyword excessively.\n\nNow implement contextual internal linking throughout the website.\n\nExamples:\n\nReal Estate CRM\n→ WhatsApp CRM\n→ Meta API CRM\n→ AI Chatbot\n\nMeta API CRM\n→ WhatsApp CRM\n→ All-in-One CRM\n\nAI Chatbot\n→ AI Automation\n→ CRM\n\nHyderabad Software Company\n→ Software Development\n→ CRM Development\n→ AI Development\n\nKPHB page\n→ Software Development\n→ CRM\n→ AI\n\nKukatpally page\n→ Software Development\n→ CRM\n→ AI\n\nEnsure every important SEO page has internal links.\n\nDetect and fix orphan pages.\n\nUse descriptive anchor text.\n\nDo not change the existing visual design unnecessarily.\n\nTest the global footer on:\n\nhomepage\n\ service pages\n\nCRM pages\n\nAI pages\n\nlocation pages\n\ninsights\n\ncontact\n\nabout\n\nConfirm the footer works responsively."
