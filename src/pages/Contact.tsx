...
placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Continue from all previous phases.\n\nNow perform a technical SEO and structured-data implementation.\n\nDo not redesign the website.\n\nTASK 1 — STRUCTURED DATA\n\nImplement valid JSON-LD where appropriate:\n\nOrganization\n\nLocalBusiness where appropriate\n\nWebSite\n\nWebPage\n\nBreadcrumbList\n\nService\n\nProduct where genuinely applicable\n\nArticle for blog/insight pages\n\nDo NOT create fake:\n\nreviews\n\nratings\n\nawards\n\nprices\n\nlocations\n\norganizations\n\nStructured data must accurately represent visible page content.\n\nTASK 2 — TECHNICAL SEO\n\nCheck and fix:\n\ncanonical URLs\n\nsitemap.xml\n\nrobots.txt\n\n404 page\n\nredirects\n\nredirect chains\n\nbroken links\n\nduplicate URLs\n\naccidental noindex\n\naccidental robots blocking\n\nHTTPS consistency\n\ntrailing slash consistency\n\nwww/non-www consistency\n\nTASK 3 — IMAGE SEO\n\nOptimize:\n\nalt text\n\nimage filenames\n\nimage dimensions\n\nresponsive images\n\nWebP/AVIF where appropriate\n\nlazy loading\n\nhero image loading\n\nDo not keyword stuff alt text.\n\nTASK 4 — PERFORMANCE\n\nImprove:\n\nLCP\n\nINP\n\nCLS\n\nJavaScript execution\n\nunused CSS\n\nunused JavaScript\n\nimage sizes\n\nfont loading\n\ncaching\n\nunnecessary third-party scripts\n\nMaintain the existing design.\n\nTASK 5 — MOBILE SEO\n\nTest:\n\nmobile navigation\n\nfooter\n\ntext\n\nbuttons\n\nforms\n\nimages\n\ninternal links\n\npage loading\n\nAt the end perform a complete technical SEO test and report all issues found and fixed."
                  ...
                  <div>
                    ...
                    <Textarea
                      required
                      rows={5}
                      placeholder="'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            Continue from all previous phases.\n\nNow build a scalable content architecture for SOFTURECS AI LABS.\n\nCreate an /insights/ or /blog/ structure if one does not already exist.\n\nDo NOT generate hundreds of low-quality AI articles.\n\nCreate a strong topical structure around:\n\nCRM:\n\nCRM Software\n\nReal Estate CRM\n\nWhatsApp CRM\n\nMulti CRM\n\nCRM Automation\n\nLead Management\n\nSales CRM\n\nAI:\n\nAI Chatbots\n\nAI Automation\n\nConversational AI\n\nAI CRM\n\nBusiness Automation\n\nSoftware Development:\n\nCustom Software Development\n\nSaaS Development\n\nWeb Application Development\n\nMobile App Development\n\nAPI Development\n\nLOCAL:\n\nSoftware Development in Hyderabad\n\nSoftware Companies in Hyderabad\n\nTechnology Solutions for Hyderabad Businesses\n\nSoftware Development in KPHB\n\nSoftware Development in Kukatpally\n\nCreate a scalable article template with:\n\nSEO title\n\nmeta description\n\nH1\n\nauthor/company\n\npublish date\n\nupdated date\n\narticle content\n\nheadings\n\nimages\n\ninternal links\n\nrelated articles\n\nrelated services\n\nCTA\n\nbreadcrumbs\n\nArticle schema where appropriate\n\nEvery article must link naturally to relevant commercial pages.\n\nExample:\n\nArticle about Real Estate CRM\n→ Real Estate CRM page\n→ WhatsApp CRM\n→ AI Chatbot\n\nArticle about AI Chatbots\n→ AI Chatbot Development\n→ AI Automation\n→ CRM\n\nArticle about software development in Hyderabad\n→ Hyderabad location page\n→ Software Development\n→ CRM\n\nDo not use keyword stuffing.\n\nDo not create content solely for search engines.\n\nFocus on genuinely useful content."
