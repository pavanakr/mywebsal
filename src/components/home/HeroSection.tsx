        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-primary-foreground/80">Trusted by 500+ Global Companies</span>
            </motion.div>
            ...
            >
              We craft world-class digital solutions that transform businesses. From custom software to AI-powered platforms, we bring your vision to life with precision and innovation.
            </motion.p>
